...
import com.example.wingsoffireocmaker.databinding.ItemLanguageBinding
        ...
        @SuppressLint("ResourceAsColor") fun bind(item: LanguageModel, position: Int) {
            binding.apply {
                ...
                if (item.activate) {
                    ...
                    txtLang.setTextColor("#6B1B10".toColorInt())
                    itemLang.background = ContextCompat.getDrawable(context, R.drawable.frame_language)
                } else {
