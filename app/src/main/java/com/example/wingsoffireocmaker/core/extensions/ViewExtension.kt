...
import com.example.wingsoffireocmaker.core.dialog.LoadingDialog
import com.example.wingsoffireocmaker.core.dialog.NoInternetDialog
...
fun Activity.openPlayStoreForReview(context: Context) {
